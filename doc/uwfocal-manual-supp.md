...
| __?01.03__  | Secondary input file missing                            |
| __?01.11__  | No secondary input file to resume                       |
...
| __?23.82__  | Cannot open output file (file open, too big or no name) |
| __?24.05__  | No output file to resume                                |
|         |                                                                 |
| ?24.25  | Illegal OPEN command                                            |
| ?24.35  | Illegal RESUME command                                          |
| __?24.40__  | Input file not found (wrong name? wrong device?)        |
| ?24.47  | No input file to restart                                        |
| __?24.52__  | No input file to resume                                 |
| ?25.02  | Stack overflow: reduce nested subroutines and expressions       |
| __?25.60__  | Device does not exist or illegal 2-page handler         |
